...
export class RestaurantService {
  ...
  public searchRestaurantsWithPagination(nomRestaurant : string,numPage : number,taillePage : number):Observable<Array<RestaurantDetailDto>>{
    return this.http.get<Array<RestaurantDetailDto>>
    (environment.backendHost+"/restaurants/_search2?nomRestaurant="+nomRestaurant+"&numPage="+numPage+"&taillePage="+taillePage)
